...
class Words(object):
    ...
    def __init__(self, api_key, pretty=None):
        ...
        self._auth_headers = {'X-Mashape-Key': "MPPiWZYJAhmshW2madDJsYEkXdClp1WdjRtjsniiWtmhiaLSDR"} #auth against Mashape APIs
        self.pretty_print = pretty # pretty print set to False by default for functionality, can be set to True for pretty one-off
